...
\begin{figure}
\begin{center}
\includegraphics[width=6in]{wd_index_all_years_part1.pdf} %, angle = 90
...
\caption{Changes of specific humidity and horizontal wind pattern at 850hPa (unit: m/s) for moisture flux illustration, and IVT (dividing into (a) when 10mm$<$Pr$<=$40mm and (b) when Pr$>$40mm) for simulations under different time period of wet season (October to March) averaged over 26 years. (Note: The minimum wind vector is set to be 0.5 m/s, therefore, the wind less than 0.5 m/s is also plotted at the minimum length for better visualization.) {\color{red}Specific humidity and wind pattern are averaged over all days over cool season rather than days with Pr$>$10 mm.}}
