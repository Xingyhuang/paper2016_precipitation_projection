...
On comparing \textsf{hist} and \textsf{mid}, it is clear that the number of rainy days and frequency of non-extreme precipitation events ($\leq$ 10 mm/day) have increased significantly (about 10-15$\%$) over the southwest and intermountain west and decreased significantly over the northwest region and the eastern areas of the Montana, Wyoming and Oregon (by about 10$\%$).  Comparing \textsf{hist} to \textsf{end}, these changes persist outside of the southwest region, but reverse through the end of the century in the southwest.  In these same regions, there is no statistically significant impact on extreme precipitation associated with the climate signal.  The increase in the frequency of these non-extreme precipitation events explain the observed change to mean precipitation exhibited in Figure \ref{fig:meanClm}, and are largely associated with warm season mesoscale storm systems.
...
For the most extreme precipitation events (Pr $\geq$ 40 mm/day), there is a statistically significant increase along the northwest coast ($\geq$ 60$\%$), the Cascades ($\sim$ 50$\%$) and its eastern flank ($\geq$ 60$\%$) by end-of-century. Significant increases are also apparent along the Klamath range in California of about 20-40$\%$ from \textsf{hist} to \textsf{end}. Changes in accumulated precipitation for these events are consistent with the change in their frequency (see Figure \ref{fig:difIndex2}).  {\color{red}With a projected increase of temperatures in this region of 3-4K over the cool season, this increase is in excess of the 7\% per degree change that would be anticipated from the C-C relationship (Figure \ref{fig:discussIndex}a).  In this case, the probable cause of this excess is due to the intensification of the storm track along the coast discussed in section \ref{sec:ResultsMeanClimatology}. [Paul: Check]} 
