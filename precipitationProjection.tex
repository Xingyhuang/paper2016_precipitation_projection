...
\caption{The mean precipitation and other related indices from VR-CESM and reference datasets over 1980-2005. (Note: Grids with statistically significance difference are marked with stippling.)}
\label{fig:Figure 2}
\end{center}
\end{figure}
